...
public class mapCourseCategoryAdapter extends RecyclerView.Adapter<mapCourseCategoryAdapter.CustomViewHolder> {
    ...
    @NonNull
    @Override
    public mapCourseCategoryAdapter.CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull mapCourseCategoryAdapter.CustomViewHolder holder, int position) {
